...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final int CIRCLE_BG_LIGHT = 0xFFFF77;
    ...
    private void createProgressView() {
        mCircleView = new CircleImageView(getContext(), R.color.aliceBlue);
        mCircleView.setBackgroundColor(getResources().getColor(R.color.aliceBlue));
        mProgress = new MaterialProgressDrawable(getContext(), this);
        mProgress.setBackgroundColor(R.color.aliceBlue);
        mCircleView.setImageDrawable(mProgress);
        mCircleView.setVisibility(View.GONE);
        addView(mCircleView);
    }
